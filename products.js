document.addEventListener("DOMContentLoaded",()=>{
 ...
 function render(){
  ...
  $$("[data-remove]").forEach(b=>b.onclick=()=>{KDCart.remove(b.dataset.remove);render()});$$("[data-qty]").forEach(i=>i.onchange=()=>{KDCart.update(i.dataset.qty,{qty:Math.max(1,+i.value)});render()})
 }
 render();
});
